...
class Node {
    ...
    createTextNode() {
        ...
        if (this.hasCustomText) {
            ...
            customText.forEach((item, index) => {
                ...
                this.style.setCustomTextIndex(index)
                ...
                item.content.split(/\n/gim).forEach((childItem, childIndex) => {
                    ...
                    this.style.text(node, true, index)
    ...
    measureText(val, fontSize) {
        ...
        context.font = font
        const {width, actualBoundingBoxAscent, actualBoundingBoxDescent} = context.measureText(val)
