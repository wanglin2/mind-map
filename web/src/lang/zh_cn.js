export default {
  ...
  attachment: {
    ...
    upload: '上传附件',
    uploadTitle: '上传附件',
    uploadTip: '点击此处选择文件、或拖动文件到此',
    uploading: '上传中...',
    uploadSuccess: '附件上传成功',
    uploadFailed: '附件上传失败',
    noFileSelected: '请先选择文件',
    preview: '附件预览',
    noAttachment: '该节点没有附件',
    cannotPreview: '该文件类型不支持预览，请下载后查看',
    download: '下载文件',
    loadFailed: '加载文件内容失败',
    officePreviewMessage: 'Office文档需要公网可访问的URL才能预览，请下载后查看',
    previewMethodHint: '请选择Office预览方式：',
    previewFailed: '当前预览方式加载失败，请尝试其他预览方式',
    officeTextPreview: 'Office文档以纯文本模式显示，格式可能不正确。建议下载后查看完整内容。',
    officeTextLoading: '正在加载Office文档内容...',
    officeTextFailed: '无法以文本形式显示此Office文档内容。请下载后查看。',
    officeTextSuccess: 'Office文档以纯文本模式显示（可能包含部分格式代码）：'
  },
  annotation: {
    mark: '标记',
    show: '显示标记',
