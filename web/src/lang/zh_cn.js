export default {
  ...
  theme: {
    ...
    endColor: '渐变结束色',
    associativeLine: '关联线',
    associativeLineWidth: '关联线粗细',
    associativeLineColor: '关联线颜色',
    associativeLineActiveWidth: '激活粗细',
    associativeLineActiveColor: '激活颜色',
    associativeLineStyle: '关联线样式',
    associativeLineText: '关联线文字',
    associativeLineTextColor: '文字颜色',
    associativeLineTextFontSize: '文字大小',
    associativeLineTextFontFamily: '文字字体',
    generalizationLine: '概要连线',
    generalizationLineWidth: '概要连线粗细',
    generalizationLineColor: '概要连线颜色',
    themeName: '主题名称',
    ...
    selectFile: '选择文件',
    preview: '预览',
    nodeUseLineStyle: '仅底边框样式',
    lineFlow: '流动效果',
    lineFlowDuration: '流动周期',
    lineFlowForward: '流动方向',
    forward: '正向',
    reverse: '反向',
    themeMarket: '主题市场',
    minimalist: '简约风',
