...
<li><input type="checkbox" id="checkbox4" checked="true" /><label for="checkbox4">Nodes support drag and drop (drag and move, freely adjust), multiple node shapes, and fully customize node content using DDM</label></li>
...
<li><input type="checkbox" id="checkbox7" checked="true" /><label for="checkbox7">Supoorts to export as </label><code>json</code>、<code>png</code>、<code>svg</code>、<code>pdf</code>、<code>markdown</code>、<code>xmind</code>, support import from <code>json</code>、<code>xmind</code>、<code>markdown</code></li>
<li><input type="checkbox" id="checkbox8" checked="true" /><label for="checkbox8">Support shortcut keys, forward and backward, correlation lines, search and replacement, small maps, watermarks, and scrollbar</label></li>
...
<ul>
<li><input type="checkbox" id="checkbox11" checked="true" /><label for="checkbox11">Toolbar, which supports inserting and deleting nodes, and editing node</label>
images, icons, hyperlinks, notes, tags, and summaries</li>
<li><input type="checkbox" id="checkbox12" checked="true" /><label for="checkbox12">Sidebar, with panels for basic style settings, node style settings,</label>
outline, theme selection, and structure selection</li>
<li><input type="checkbox" id="checkbox13" checked="true" /><label for="checkbox13">Import and export functionality; data is saved in the browser's local</label>
storage by default, but it also supports creating, opening, and editing
local files on the computer directly</li>
<li><input type="checkbox" id="checkbox14" checked="true" /><label for="checkbox14">Right-click menu, which supports operations such as expanding, collapsing,</label>
and organizing layout</li>
<li><input type="checkbox" id="checkbox15" checked="true" /><label for="checkbox15">Bottom bar, which supports node and word count statistics, switching</label>
