...
<p>修复：</p>
<blockquote>
<p>1.修复历史记录数据中概要节点的激活状态未被删除的问题，会导致点击概要节点时触发data_change事件。</p>
<p>2.修复在safari浏览器中运行时，页面空白且控制台抛出异常的问题。</p>
...
<p>3.导出png的方法新增压缩参数；优化大数据量节点导出pdf时体积过大的问题。</p>
<p>4.将节点实例的isParent方法改名为isAncestor，同时新增isParent方法。</p>
</blockquote>
<p>Demo：</p>
<blockquote>
...
<p>新增：</p>
<blockquote>
<p>1.优化画布DOM结构，将节点、连线、关联线分层渲染。</p>
<p>2.优化水印插件。</p>
<p>3.setTheme、setThemeConfig、setLayout函数增加不触发重新渲染的参数。</p>
<p>4.新增插入父节点的命令。</p>
<p>5.新增仅删除当前节点的命令。</p>
<p>6.插入概要时自动展开子节点。</p>
...
<p>12.优化Select插件，如果多选节点没有变化，那么不触发激活激活事件。</p>
...
<p>3.导出图片由html2canvas库改为使用dom-to-image-more库，解决导出富文本节点文字样式丢失的问题。</p>
...
<p>修复：1.修复按住ctrl键多选节点时不会触发节点的click事件的问题。 2.修复清空一个节点后再输入文字时节点样式丢失的问题。</p>
<h2>0.5.11</h2>
<p>新增：支持关联性文本编辑。</p>
